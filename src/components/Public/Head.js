...
export default class Head extends PureComponent {
  ...
  componentDidMount() {
    ...
    let self = this;
    //收到监听
    this.listener = DeviceEventEmitter.addListener('updateTitle', () => {
      self.setState({ title: global.H5Title })
    })
  }
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Text style={{color:'#000',fontSize:scaleSize(32)}}>
          {this.state.title ? this.state.title : '基层治理'}
        </Text>
        ...
        {this.props.switch ? (
          <TouchableOpacity
            ...
            <Image
              source={
                this.props.type === 1
                  ? require('../../assets/mapHead.png')
                  : require('../../assets/listHead.png')
              }
